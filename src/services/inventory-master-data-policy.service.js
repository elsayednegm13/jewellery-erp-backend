...
const GEMSTONE_SHAPES = Object.freeze(["Asscher", "Baguette", "Briolette", "Cabochon", "Cushion", "Emerald Cut", "Freeform", "Heart", "Hexagon", "Marquise", "Octagon", "Oval", "Pear", "Princess", "Radiant", "Round", "Square", "Triangle", "Trillion"]);
...
const GEMSTONE_TONE_LEVELS = Object.freeze(["Dark", "Extremely Dark", "Extremely Light", "Light", "Medium", "Medium Dark", "Medium Light", "Very Dark", "Very Light"]);
...
const GEMSTONE_OPTICAL_EFFECTS = Object.freeze(["None", "Adularescence", "Asterism", "Aventurescence", "Chatoyancy", "Color Change", "Iridescence", "Labradorescence", "Orient", "Play Of Color", "Other"]);
