...
const PROFILE_REGISTRY = Object.freeze({
  ...
  // Loose Gemstone has one physical measurement authority: CT. Grams are a
  // server-derived reporting value (CT x 0.20), never a user-entered stock
  // fact. Keep purchaseCost as the pre-tax acquisition base.
  LOOSE_GEMSTONE: Object.freeze({ aliases: [], assetType: "gemstone", family: "GEMSTONE", condition: CONDITION.OPTIONAL, pricing: "LOOSE_ASSET_STRATEGY", required: ["description", "purchaseCost", "looseDetails"], optional: COMMON_OPTIONAL_FIELDS, weightApplicable: false, certificateSupported: true, componentsSupported: false, rfidAllowed: true, locationOptional: false, looseDetails: LOOSE_DETAIL_CONTRACTS.LOOSE_GEMSTONE }),
  ...
  LOOSE_PEARL: Object.freeze({ aliases: [], assetType: "pearl", family: "PEARL", condition: CONDITION.OPTIONAL, pricing: "LOOSE_ASSET_STRATEGY", required: ["description", "purchaseCost", "looseDetails"], optional: COMMON_OPTIONAL_FIELDS, weightApplicable: false, certificateSupported: true, componentsSupported: false, rfidAllowed: true, locationOptional: false, looseDetails: LOOSE_DETAIL_CONTRACTS.LOOSE_PEARL }),
...
function normalizeLooseDetails(profile, input = {}) {
  ...
  const result = {
    ...
    otherDescription: text(input.otherDescription || input.otherValueDescription),
