...
module.exports = sequelize.define("CustomerGoldPurchaseItem", {
  ...
  proposedRate: { type: DataTypes.DECIMAL(20, 4), field: "proposed_rate" },
  referenceMarketRate: { type: DataTypes.DECIMAL(20, 4), field: "reference_market_rate" },
  deductionMetadata: { type: DataTypes.JSONB, allowNull: false, defaultValue: {}, field: "deduction_metadata" },
  notes: { type: DataTypes.TEXT },
  version: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 1 }
}, { tableName: "customer_gold_purchase_items", timestamps: true, underscored: true, paranoid: true });
