...
async function main() {
  ...
  try {
    ...
    assert.equal(decimal(invW.subtotal), 1120, "Gold By Weight subtotal must equal gold (8x120=960) + making (8x20=160) = 1120");
    ...
    assert.equal(decimal(detailW.body.data.salePricing.makingTotal), 160, "Read-back making total must be exact");
