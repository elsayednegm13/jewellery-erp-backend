...
const { CGP_IMP_01_MIGRATIONS, CGP_IMP_02_MIGRATIONS, CGP_IMP_11_MIGRATIONS, CGP_IMP_03_MIGRATIONS, CGP_PRICE_AUTHORITY_CLOSURE_MIGRATIONS, CGP_IMP_04_MIGRATIONS, CGP_IMP_05A_MIGRATIONS, CGP_IMP_05_MIGRATIONS, CGP_IMP_06_MIGRATIONS, CGP_IMP_08_MIGRATIONS, CGP_IMP_09A_MIGRATIONS, CGP_IMP_09_MIGRATIONS, CGP_IMP_10A_MIGRATIONS, CGP_IMP_10_MIGRATIONS, GOLD_LIVE_FEED_01_MIGRATIONS, GOLD_LIVE_FEED_03_MIGRATIONS, GOLD_LIVE_FEED_04_MIGRATIONS, runAcceptanceMigrationCommand } = require("./acceptance-migration-guard");
...
const goldLiveFeed04 = process.argv.slice(2).includes("--gold-live-feed-04");

if ([cgpImp01, cgpImp02, cgpImp11, cgpImp03, cgpPriceAuthorityClosure, cgpImp04, cgpImp05a, cgpImp05, cgpImp06, cgpImp08, cgpImp09a, cgpImp09, cgpImp10a, cgpImp10, goldLiveFeed01, goldLiveFeed03, goldLiveFeed04].filter(Boolean).length > 1) {
  ...
  ...(goldLiveFeed04 ? { expectedMigrations: GOLD_LIVE_FEED_04_MIGRATIONS } : {}),
})
  .then((result) => {
