...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.bulkInsert("invoices", [
      { id: "INV-10486", company_id: "CMP-DEMO", type: "sale", customer_id: "CUS-0012", customer_name: "مريم سالم", date: "2026-06-12 19:22", subtotal: 4086, total: 4290, tax: 204, status: "paid", payment_method: "بطاقة", branch: "فرع أبوظبي", posted_at: "2026-06-12 19:22", created_at: now, updated_at: now },
      { id: "INV-10485", company_id: "CMP-DEMO", type: "sale", customer_id: "CUS-0058", customer_name: "نورا الهاشمي", date: "2026-06-12 18:45", subtotal: 16000, total: 16800, tax: 800, status: "paid", payment_method: "تحويل بنكي", branch: "فرع دبي مول", posted_at: "2026-06-12 18:45", created_at: now, updated_at: now },
      { id: "INV-10484", company_id: "CMP-DEMO", type: "sale", customer_id: "CUS-0026", customer_name: "خالد المنصوري", date: "2026-06-12 16:18", subtotal: 10714, total: 11250, tax: 536, status: "partial", payment_method: "تقسيط", branch: "فرع الشارقة", created_at: now, updated_at: now },
      { id: "INV-10483", company_id: "CMP-DEMO", type: "sale", customer_id: "CUS-0034", customer_name: "دانة العتيبي", date: "2026-06-12 13:05", subtotal: 7524, total: 7900, tax: 376, status: "paid", payment_method: "نقدي", branch: "فرع دبي مول", posted_at: "2026-06-12 13:05", created_at: now, updated_at: now },
      { id: "INV-10482", company_id: "CMP-DEMO", type: "sale", customer_id: "CUS-0041", customer_name: "يوسف إبراهيم", date: "2026-06-11 20:40", subtotal: 6000, total: 6300, tax: 300, status: "due", payment_method: "عربون", branch: "فرع أبوظبي", created_at: now, updated_at: now }
    ]);
