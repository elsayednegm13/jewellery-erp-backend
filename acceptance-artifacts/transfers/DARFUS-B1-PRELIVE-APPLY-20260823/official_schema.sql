...
\restrict w7x13F6TdWCGRY3gP4ff1DrTyDbtpvIAHMpfrArgPpAfENxjmSfa8mNmQmG0V6a
...
CREATE UNIQUE INDEX transfer_items_one_active_uq ON public.transfer_items USING btree (asset_id) WHERE ((status)::text = ANY ((ARRAY['REQUESTED'::character varying, 'APPROVED'::character varying, 'DISPATCHED'::character varying])::text[]));
...
\unrestrict w7x13F6TdWCGRY3gP4ff1DrTyDbtpvIAHMpfrArgPpAfENxjmSfa8mNmQmG0V6a
