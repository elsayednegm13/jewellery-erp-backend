...
\restrict R8NyBMgcZItTvcSDZu3OpEZiIocCej7NLGsG1yxYj1JyutpUT2xHoKIsv5ub497
...
CREATE TABLE public.inventory_workshop_orders (
    ...
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    workshop_location_id character varying(255),
    return_location_id character varying(255)
);
...
CREATE UNIQUE INDEX transfer_items_one_active_uq ON public.transfer_items USING btree (asset_id) WHERE ((status)::text = ANY (ARRAY[('PENDING'::character varying)::text, ('APPROVED'::character varying)::text, ('IN_TRANSIT'::character varying)::text]));
...
--
-- Name: inventory_workshop_orders inventory_workshop_orders_return_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.inventory_workshop_orders
    ADD CONSTRAINT inventory_workshop_orders_return_location_id_fkey FOREIGN KEY (return_location_id) REFERENCES public.inventory_locations(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: inventory_workshop_orders inventory_workshop_orders_workshop_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.inventory_workshop_orders
    ADD CONSTRAINT inventory_workshop_orders_workshop_location_id_fkey FOREIGN KEY (workshop_location_id) REFERENCES public.inventory_locations(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
\unrestrict R8NyBMgcZItTvcSDZu3OpEZiIocCej7NLGsG1yxYj1JyutpUT2xHoKIsv5ub497
